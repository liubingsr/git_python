...
def function(x, y):
    ...
    for i_month in range(1, month):
        ...
        #充电
        if deltE[i_month] >= 0:            
            E_battery[i_month] = E_battery[i_month - 1] + deltE[i_month]*Coef_converter*eta_battery_charge
        ...
        #放电
            ...
            E_battery[i_month] = E_battery[i_month - 1] - deltE[i_month]/eta_battery_discharge/Coef_converter
